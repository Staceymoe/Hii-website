...
for (const sharedFooterPath of sharedFooterPages) {
  ...
  if (!/rel="preload" href="\/media\/hii-hero-front-door-final-frame\.webp" as="image"/.test(sharedFooterPage)) fail(`${sharedFooterPath} is missing the return-state preload`);
}
